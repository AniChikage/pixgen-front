...
function Nav () {
    ...
    return (
        <div className=" bg-black/[.6] backdrop-blur-lg fixed z-50 flex h-14 w-full justify-between items-center">
            <div className='relative flex justify-between w-full max-w-[80rem] mx-auto px-4'>
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <li>
                        <details>
                        <summary className='text-white text-base'>工具</summary>
                        ...
                        >
                            <li>
                                ...
                                <div className="grow w-60">
                                    <p className="font-medium text-white/75 group-hover:text-black group-hover:text-black">背景模糊</p>
                            ...
                            <li>
                                ...
                                <svg className="flex-shrink-0 w-5 h-5 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="green" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
                                <div className="grow w-60">
                                    <p className="font-medium text-white/75 group-hover:text-black">橡皮擦</p>
                            ...
                            <li>
                                ...
                                <svg className="flex-shrink-0 w-5 h-5 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="green" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
                                <div className="grow w-60">
                                    <p className="font-medium text-white/75 group-hover:text-black">消除背景</p>
                            ...
                            <li>
                                ...
                                <svg className="flex-shrink-0 w-5 h-5 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="green" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
                                <div className="grow w-60">
                                    <p className="font-medium text-white/75 group-hover:text-black">一键换脸</p>
                            ...
                            <li>
                                ...
                                <svg className="flex-shrink-0 w-5 h-5 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="green" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
                                <div className="grow w-60">
                                    <p className="font-medium text-white/75 group-hover:text-black">
                                    高清修复
                                    </p>
                    ...
                    <li><a className='text-whtie text-base' href="/price">定价</a></li>
                    </ul>
                </div>
                <div className='w-14 flex items-center justify-between'>
                    {
                        ...
                        >
                            ...
                            <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  rounded-lg w-40"
                                 style={{
                                    backgroundColor: "#0F0F0F"
                                }}
                            >
                                <li>
                                    <a className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100 light:text-gray-400 light:hover:bg-gray-700 light:hover:text-gray-300 light:focus:bg-gray-700" href="/profile">
                                ...
                                <li>
                                    <a className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100 light:text-gray-400 light:hover:bg-gray-700 light:hover:text-gray-300 light:focus:bg-gray-700" href="/#" onClick={logout}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
                    ...
                    }
                    {
                        ...
                        <div className="flex items-center justify-end w-14 rounded-md">
                            <a className="flex items-center gap-x-2 font-medium text-white hover:text-blue-600 light:text-gray-400 light:hover:text-blue-500" href="/login">
