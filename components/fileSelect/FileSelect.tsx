...
const FileSelector = (props: any) => {
    ...
    return (
        <div className="w-full mx-auto py-20 bg-white dark:bg-black "
            // style={{
        ...
        <div className="w-3/4 mx-auto my-20 ">
            ...
            <label
                className="flex justify-center w-full h-60 px-4 rounded-3xl transition bg-white dark:bg-black border-2 border-gray-300 border-dashed appearance-none cursor-pointer hover:bg-blue-200  hover:border-gray-400 focus:outline-none">
                <span className="flex items-center space-x-2 ">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-black dark:text-white" fill="none" viewBox="0 0 24 24"
