        ...
        >
            ...
            <div className="modal-box text-white bg-white/95 dark:text-black dark:bg-white/95 w-96">
                ...
                <div className="flex justify-center items-center">
                    <button type="button" className="hover:scale-105 duration-300 px-3"
                ...
                <form method="dialog">
                    <button className="btn bg-white hover:bg-white border-none shadow-none hover:scale-105 duration-300">
            ...
            {/* <div className="flex justify-center items-center">
                <label className="min-w-[3.5rem] text-sm text-white me-3 light:text-gray-400">Monthly</label>
                ...
                <label className="relative min-w-[3.5rem] text-sm text-white ms-3 light:text-gray-400">
                Annual
            ...
            <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
                ...
                <h4 className="font-medium text-lg text-black dark:text-white">套餐一</h4>
                ...
                <div className="flex flex-col bg-white dark:bg-black border  border-blue-800 text-center rounded-xl p-8 light:border-gray-700">
                <h4 className="font-medium text-lg text-black dark:text-white">套餐二</h4>
                <span className="mt-5 font-bold text-5xl text-black dark:text-white">
                    {/* <span className="font-bold text-3xl -me-2">¥</span> */}
                    24.9¥
                </span>
                {/* <p className="mt-2 text-sm text-white">短期需求，试用产品</p> */}
                ...
                <h4 className="font-medium text-lg text-black dark:text-white">套餐三</h4>
                <span className="mt-5 font-bold text-5xl text-black dark:text-white">
                ...
                <div className="flex flex-col bg-white dark:bg-black border  border-blue-800 text-center rounded-xl p-8 light:border-gray-700">
                <h4 className="font-medium text-lg text-black dark:text-white">套餐四</h4>
                <span className="mt-5 font-bold text-5xl text-black dark:text-white">
                    {/* <span className="font-bold text-2xl -me-2">$</span> */}
                    149.9¥
                </span>
