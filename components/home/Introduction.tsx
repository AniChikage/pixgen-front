...
function Introdcution () {
    return (
        <div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 light:before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element-dark.svg')]">
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                ...
                <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl light:text-gray-200">
                    智能美学，
                    <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">图片焕新</span>
                </h1>
                </div>

                <div className="mt-5 max-w-3xl text-center mx-auto">
                <p className="text-lg text-gray-600 light:text-gray-400">
                一个基于人工智能技术的图片处理平台，提供强大的图像处理功能，通过先进的算法，我们助力用户轻松优化、编辑和个性化图片
                </p>
                </div>

                <div className="mt-8 gap-3 flex justify-center">
                <a className="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 light:focus:ring-offset-gray-800" href="#">
                    Get started
                ...
                <span className="text-sm text-gray-600 light:text-gray-400">Package Manager:</span>
                <span className="text-sm font-bold text-gray-900 light:text-white">npm</span>
                <svg className="h-5 w-5 text-gray-300 light:text-gray-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
