...
export default function Goods() {
    return (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-12">
            ...
            <div className="mt-5">
                <h3 className="text-lg font-semibold text-neutral-800 dark:text-white">个性化</h3>
                <p className="mt-1 dark:text-white text-gray-900 ">基于AI模型，一键处理图片</p>
            </div>
            </div>
            ...
            <div className="mt-5">
                <h3 className="text-lg font-semibold text-neutral-800 dark:text-white">便宜</h3>
                <p className="mt-1 dark:text-white text-gray-900">提供便宜的付费计划</p>
            </div>
            </div>
            ...
            <div className="mt-5">
                <h3 className="text-lg font-semibold text-neutral-800 dark:text-white">效果好</h3>
                <p className="mt-1 dark:text-white text-gray-900">集成当前最优的模型</p>
            </div>
            </div>
            ...
            <div className="mt-5">
                <h3 className="text-lg font-semibold text-neutral-800 dark:text-white">24/7 支持</h3>
                <p className="mt-1 dark:text-white text-gray-900">7乘24小时联系我们，提供技术支持</p>
            </div>
            </div>
        </div>
        </div>
