    ...
    return (
        ...
        <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <h2 className="font-bold text-3xl lg:text-4xl text-gray-800 light:text-gray-200">
                ...
                <li className="flex space-x-3">
                    <span className="mt-0.5 h-5 w-5 flex justify-center items-center rounded-full bg-blue-50 text-blue-600 light:bg-blue-800/30 light:text-blue-500">
